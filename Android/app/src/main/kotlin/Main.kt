...
internal val logger: SkipLogger = SkipLogger(subsystem = "focus.garden", category = "FocusGarden")

private typealias AppRootView = FocusGardenRootView
private typealias AppDelegate = FocusGardenAppDelegate
